...
<html>
    ...
    <div class="mainContent">
        <aside class="show_Desktop">
            <img src="src/img/teacher1.png" alt="">
        </aside>
        <div class="personInfo">
            ...
            <p class="gray spacing">Mokymų vedėjas, milijonierius, verslo žmogus</p>
            <div class="biography">
                <div>
                    <p class="title spacing">Biografija</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet voluptates beatae dolores soluta aperiam necessitatibus, autem iure inventore quo veniam quos voluptatibus quis perferendis saepe neque sit nam veritatis maiores harum itaque laboriosam officia, exercitationem ut? Dolorem minus, nulla iste, eaque voluptates adipisci corporis excepturi ipsa ut explicabo, voluptas possimus mollitia ullam facilis voluptatibus odio? Id commodi veritatis fugit voluptatibus laudantium. Unde nostrum sequi, earum laudantium voluptatem necessitatibus non labore architecto, quia delectus dolorem totam dolorum esse nihil possimus. Eius?</p>
                </div>
                <div>
