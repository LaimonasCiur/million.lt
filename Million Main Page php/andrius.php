...
<html>
    ...
    <div class="mainContent">
        <aside class="show_Desktop">
            <img src="src/img/teachers/teacher2.png" alt="">
        </aside>
        <div class="personInfo">
            ...
            <p class="gray spacing">Mokymų vedėjas, NLP ir Koučingo specialistas</p>
            <div class="biography">
                <div>
                    <p class="title spacing">Apie Andrių</p>
                    <p>BNI Lietuva regiono direktorius. Specializuojasi patirtinio mokymosi, įtaigios komunikacijos, nuostatų ir nuomonės formavimo srityse.</p>
                </div>
                <div>
